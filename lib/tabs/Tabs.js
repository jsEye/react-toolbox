    ...
    function Tabs() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Tabs.__proto__ || Object.getPrototypeOf(Tabs)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        if (idx >= 0) {
          ...
          var left = scrollLeft > 0;
          var right = nav.right < lastLabel.right - 5;
          var _this$state$arrows = _this.state.arrows,
              prevLeft = _this$state$arrows.left,
              prevRight = _this$state$arrows.right;
